        ...
        try {
          ...
          historicalDataByChain[chainName][platformName] = {
            ...
            data: [
              {
                date: '2024-01-01',
                apy: poolInfo.apy * 0.9,
                tvl: poolInfo.tvl * 0.8,
              },
              {
                date: '2024-02-01',
                apy: poolInfo.apy * 0.95,
                tvl: poolInfo.tvl * 0.9,
              },
...
function createTestRequest(poolInfo, historicalData) {
  return {
    userPrompt:
      "Please analyze my portfolio and provide optimization recommendations. I'm looking to maximize yield while managing risk appropriately.",
    model: 'google',
    context: {
