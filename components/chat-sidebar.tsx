            ...
            <SidebarMenu className="h-full flex flex-col">
              ...
              <SidebarMenuItem className="mt-auto">
                <SidebarMenuButton
                  onClick={() =>
                    window.open(
                      'https://github.com/agoric-labs/agoric-mcp-chat',
                      '_blank',
                    )
                  }
                  className="w-full flex items-center gap-2 transition-all hover:bg-secondary/50 active:bg-secondary/70 cursor-pointer"
              ...
              <SidebarMenuItem>
                <SidebarMenuButton className="w-full p-2 flex items-center justify-between gap-2 transition-all hover:bg-secondary/50 active:bg-secondary/70 cursor-default">
