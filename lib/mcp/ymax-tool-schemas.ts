...
export const ymaxMcptoolSchemas = {
  ...
  'trace-axelar-gmp-step': {
    inputSchema: z.object({
      ...
      agoricAddress: bech32Agoric.describe(
        'Source Agoric address (agoric1...)',
      ),
      size: z
        .number()
        .optional()
  ...
  'trace-agoric-funding-ack-step': {
    inputSchema: z.object({
      ...
      take: z
        ...
        .default(20)
        .describe(
          'Number of transactions to fetch (max 20, Mintscan API limit)',
        ),
    }),
  },
  ...
  'trace-cctp-noble-step': {
    inputSchema: z.object({
      ...
      destinationEvmAddress: evmAddress.describe(
